...
## INVESTMENT THESIS
The screen passes **8 of 22 models** (composite 83%; sector-relative 79%) across all four value families: **cheapness, dividend, GARP and risk**. Passed models include Schloss Low P/B (P/B 1.01), FCF Yield (~8.0%), Neff PEGY, High Dividend Yield (4.8%), Dividend Growth, Dreman Contrarian, Composite Value and Financial Health. Leverage screens cleanly (D/E ~38%). Timing is **Accumulate** (RSI ~50; price ~0.1% below the 200-day SMA; MACD improving).

For a value investor, the hook is a profitable, cash-generative industrial trading near book after a prolonged de-rating, with a stable ~£31m annual dividend that management increased alongside FY2025 results (per Yahoo earnings-call summaries). Business quality is adequate rather than exceptional: ROE is modest at 6.9%, revenue fell in FY2022–FY2024 before recovering in FY2025, and goodwill/intangibles dominate the balance sheet (£673m of £1,102m total assets). The screen identifies **mispricing relative to cash returns and asset backing**, not a high-quality growth compounder. The GARP pass suggests the market may be underpricing the FY2025 earnings step-up (diluted EPS 17.8p vs 13.3p in FY2024) without fully re-rating the multiple.

## FINANCIAL REVIEW
**Source limitation:** The filings index catalogues **48 UK RNS announcements** (regime: `uk_rns`), including **2 annual** and **2 interim** items, but **zero downloadable body extracts** are available under `filings/bodies/` (`with_body: 0`). Headlines confirm the following were released: FY2025 full-year results and investor Q&A (Mar 2026), annual report/AGM notice (May 2026), a trading update (May 2026) and half-year results (Jun 2026). **All figures below are sourced from `financials_annual.json` (Yahoo Finance fallback).**
...
Revenue declined for two consecutive years through FY2024, consistent with a weak UK construction cycle, before recovering **+7.3%** in FY2025—matching Yahoo's FY2025 earnings-call headline. Net income rose **+35%** YoY to £45.2m, aided by lower special charges (£9.2m vs £19.6m in FY2024 per Yahoo unusual-items data), though restructuring/M&A costs remain recurring (£8.2m in FY2025). Normalised EBITDA (Yahoo) reached £122.1m vs reported EBITDA £112.9m. Operating margin remains stable at ~13%; gross margin improved to ~44% in FY2025 from ~42% in FY2023, suggesting mix and volume recovery rather than broad pricing power.

**Balance sheet and leverage (FY2024–FY2025)**

- Total assets: £993.0m → £1,101.6m  
- Equity: £643.0m → £662.9m  
- Net debt: £101.6m → **£179.3m** (+77%)  
- Total debt: £172.8m → £252.9m  
- Goodwill + intangibles: £580.2m → £673.0m  
- Tangible book value: £62.8m → **–£10.1m**  
- Working capital: £66.5m → £73.2m  

Net debt increased materially in FY2025, driven by **£105.6m of business acquisitions** (Yahoo cash-flow statement) alongside £31.3m of dividends. The Schloss P/B pass reflects equity backing, but **tangible asset coverage is negative**—a material caveat for deep-value investors. Net debt/EBITDA is ~1.6×; interest coverage (EBIT/interest) ~6.1×. D/E at ~38% remains within the screen's risk threshold.
...
FCF conversion is solid and has supported a stable dividend. FY2025 FCF dipped slightly from the FY2024 peak as acquisition spend absorbed cash. Yahoo earnings-call summaries note management characterising the environment as "challenging" despite resilient profitability—consistent with margin pressure rather than demand collapse.

**Interim filings**

Two interim RNS headlines are indexed—a **Trading Update** (22 May 2026) and **Half-year results** (9 Jun 2026)—but contain **no extractable financial data** in this source set. No half-year figures can be cited without inventing numbers.

## RISKS AND RED FLAGS
**Cyclical/construction exposure.** Revenue fell ~10% from the FY2022 peak to the FY2024 trough before FY2025 recovery. A renewed UK housing slowdown or RMI deferral would pressure volumes and margins; management's "challenging" trading language (Yahoo earnings summaries, Mar 2026) supports this risk.

**Balance sheet intangibles and acquisition risk.** Goodwill of £509.6m (FY2025) against net income of £45.2m implies significant impairment sensitivity. Tangible book turned negative after FY2025 M&A. Bolt-on acquisitions indexed in RNS headlines include Monodraught (Sep 2025) and blue/green roof and underfloor heating acquisitions (Aug 2024); integration execution risk is real.
...
**Filings index contamination.** The RNS feed includes headlines likely unrelated to Genuit (e.g. Smith+Nephew robotics, acquisition of SheerLuxe, recommended cash offers from 2024–2025). Items such as "Final Announcement Released" and "Transaction in Own Shares" (20 Jul 2026) **cannot be verified as Genuit-specific** without primary filing text. Treat corporate-action signals as unverified.
...
- **"REG - Genuit Group PLC Aviva PLC - Holding(s) in Company"** — TradingView, 11 Jun 2026: institutional holding disclosure.  
- **RNS headlines (Investegate, no bodies):** Acquisition of Monodraught (1 Sep 2025); FY2025 results notice (29 Jan 2026); trading update (22 May 2026); half-year results (9 Jun 2026); annual report/AGM notice (29 May 2026).

**Peripheral coverage:**

- Genuit appears in generic UK dividend and European undervalued small-cap round-ups (Yahoo Finance, Jan–Jun 2026)—supportive of the value narrative but not company-specific analysis.
