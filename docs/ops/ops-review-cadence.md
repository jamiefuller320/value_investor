...
| **Monthly** | Plan refresh day (default the 8th) or surplus day before it | Declare unused Cursor fraction; assess / apply / later review a provisional `weekly_ops_cap` bump (not rememo caps; 15% of plan credit / week is an estimated-USD warning) | `docs/data/cycle_budget_surplus.json`, `docs/data/library/policy.json` | [cycle-budget-surplus.md](cycle-budget-surplus.md) |
...
| Ingest deviations (record; human approve/dismiss) | After each library deepen | [ingest-deviations.md](ingest-deviations.md) |
