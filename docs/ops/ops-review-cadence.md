...
| **Monthly** | Plan refresh day (default the 8th) or surplus day before it | Declare unused Cursor fraction; assess / apply / later review a provisional `weekly_ops_cap` bump (not rememo caps; ceiling 15% of plan credit / week) | `docs/data/cycle_budget_surplus.json`, `docs/data/library/policy.json` | [cycle-budget-surplus.md](cycle-budget-surplus.md) |
