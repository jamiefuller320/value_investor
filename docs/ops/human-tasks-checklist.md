...
| Dual-path **sleeve episodes** (widest buy-tier lifecycle + on_book/off_book/never_funded tags; observe-only) | CI | [dual-path-sleeve-lab.md](dual-path-sleeve-lab.md#artifacts) |
