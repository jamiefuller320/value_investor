...
| **Project traffic** pause / unstick / grounded EOD digest + merges-today monitor (ops-monitor + weekday 12:30/17:30; one-shot escalation; ingest_narrow independent verify/auto-merge listed in digest) | CI | [project-traffic.md](project-traffic.md#authority-v1) |
