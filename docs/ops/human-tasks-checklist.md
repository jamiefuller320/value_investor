...
| **Project traffic** pause / unstick / grounded EOD digest (ops-monitor + weekday 12:30/17:30; one-shot escalation after first-line exhaustion; no merge) | CI | [project-traffic.md](project-traffic.md#authority-v1) |
