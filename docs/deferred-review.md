...
Auto-generated from [`docs/deferred-ideas.json`](deferred-ideas.json) (updated `2026-08-02T13:49:49+00:00`).
...
| L97 | **Auto-dispatch email_only after engineering queue drains** | After the first manual accelerated review cycle succeeds, optionally chain orchestrator email_only when open_count and pr_open_count hit zero post-merge, with weekly_ops cap guard. | Manual accelerated-review-cycle runbook completed once (week of 2026-08-03) and mid-week refresh materially improved Analysis tab |
