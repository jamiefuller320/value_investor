...
| N23 | **CURSOR_API_KEY still ff143faf1516 after new agent** | Shell bc-6d93a99b still has sha256_12=ff143faf1516 (old rejected key). Condition sha256_12 ≠ ff143faf1516 is false; ftse-verify-key and raw /v0/me+/v1/me still Invalid User API Key. Owner must replace cloud secret then start another new agent. | A new cloud agent reports sha256_12 different from ff143faf1516 |
