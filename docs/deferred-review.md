...
Auto-generated from [`docs/deferred-ideas.json`](deferred-ideas.json) (updated `2026-07-24T04:55:11+00:00`).
...
| N23 | **CURSOR_API_KEY still ff143faf1516 after new agent** | Shell bc-9415c9af still has sha256_12=ff143faf1516 (old rejected key). Condition sha256_12 ≠ ff143faf1516 is false; ftse-verify-key returns Invalid User API Key. Owner must replace cloud secret then start another new agent. | A new cloud agent reports sha256_12 different from ff143faf1516 |
