...
Auto-generated from [`docs/deferred-ideas.json`](deferred-ideas.json) (updated `2026-07-23T23:06:36+00:00`).
...
| N23 | **CURSOR_API_KEY still ff143faf1516 after new agent** | Shell bc-cdb43266 still has sha256_12=ff143faf1516 (old rejected key). Condition sha256_12 ≠ ff143faf1516 is false; ftse-verify-key still Invalid User API Key. Owner must replace cloud secret then start another new agent. | A new cloud agent reports sha256_12 different from ff143faf1516 |
