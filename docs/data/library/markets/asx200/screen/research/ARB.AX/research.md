...
**Annual income trend (Yahoo, A$m, June year-end):**

| Metric | FY2022 | FY2023 | FY2024 | FY2025 |
|--------|--------|--------|--------|--------|
| Revenue | 694.5 | 671.2 | 693.2 | 730.0 |
| Operating income | 165.0 | 119.7 | 140.7 | 130.1 |
| Net income | 122.0 | 88.5 | 102.7 | 97.5 |
| Diluted EPS (A$) | 1.49 | 1.08 | 1.25 | 1.18 |
| EBITDA | 191.1 | 149.6 | 171.5 | 169.8 |

Revenue recovered from the FY2023 trough (A$671.2m) to A$730.0m in FY2025 (+5.3% YoY). Net income, however, peaked at A$122.0m in FY2022 and has not fully recovered: FY2025 net income of A$97.5m fell 5.0% from FY2024 (A$102.7m) and remains ~20% below the FY2022 peak. FY2023 was distorted by a A$13.4m capital-assets impairment charge; Yahoo's normalised income field for that year is approximately A$98.2m.

Operating margin compressed from 23.8% (FY2022) to 17.8% (FY2025), driven by selling, general and administrative expense rising from A$181.7m to A$223.8m (salaries A$144.4m → A$176.2m; rent A$14.4m → A$19.7m) while revenue grew only modestly. Gross margin has remained resilient at approximately 57% of revenue.

**Cash flow and capital allocation (Yahoo, A$m):**

| Metric | FY2022 | FY2023 | FY2024 | FY2025 |
|--------|--------|--------|--------|--------|
| Operating cash flow | 84.6 | 90.4 | 125.3 | 128.0 |
| CapEx (PPE purchases) | (58.1) | (40.6) | (48.1) | (46.2) |
| Free cash flow | 22.3 | 44.5 | 73.3 | 75.0 |
| Dividends paid | (50.3) | (45.3) | (44.7) | (23.5) |
| Business acquisitions | (0.8) | — | (5.1) | (13.3) |

FCF generation improved markedly from A$22.3m to A$75.0m over four years, supporting the screen's FCF Yield pass. FY2025 included A$13.3m in business purchases, A$25.6m in investment purchases, and a sharp dividend reduction to A$23.5m from A$44.7m in FY2024 — a material payout change that cannot be explained from filing disclosures in this library.

**Balance sheet (Yahoo, FY2025, A$m):** Total assets A$904.8m; equity A$756.6m; total debt A$46.6m (predominantly capital lease obligations; current borrowings A$0.05m); cash A$69.2m; working capital A$321.5m. Inventory stands at A$249.1m (~34% of revenue), elevated for a manufacturing/retail model. Goodwill and intangibles total A$65.3m; tangible book value A$691.4m (consistent with P/B ~2.0x on the screen). Net debt is negligible (cash exceeds financial borrowings). Employee benefit provisions (current + non-current) total approximately A$23.0m.
...
**Cyclical and earnings momentum:** ARB operates in consumer cyclical 4WD accessories, tied to discretionary spending, new vehicle sales, and off-road tourism. FY2023's impairment, FY2025 margin compression, and reported H1 FY2026 profit decline (news only) indicate earnings sensitivity to volume and cost inflation. Yahoo data (Dec 2025) and news coverage flag slowing returns on capital as the company invests in US expansion, retail stores, and acquisitions.

**OEM channel weakness:** Multiple July 2026 headlines highlight sliding OEM sales as a structural headwind (*"ARB Corporation (ASX: ARB) Faces Test as OEM Sales Slide"*, Kalkine, 19 Jul 2026), a channel the screen's Economic Moat pass does not fully capture.

**Working capital and inventory:** Inventory of A$249.1m (A$16.8m allowance) represents substantial obsolescence and markdown risk if domestic demand softens; FY2025 inventory rose modestly versus FY2024 (A$239.8m).

**Foreign exchange and geographic execution:** H1 FY2026 commentary (news, Feb 2026) cites currency headwinds alongside US growth — execution risk in international scaling without filing-level segment detail. Macro context (optional colour only): AUD/USD 0.6983 as of 25 Jul 2026.

**Governance and payout:** The FY2025 dividend cut (A$23.5m vs A$44.7m prior year) is unexplained in available sources; insider buying may signal management confidence in the share price but reduced near-term cash returns.
...
**Earnings and trading updates (unverified against filings):**
- **24 Feb 2026** — H1 FY2026 half-year result: ~19% profit decline, 15% share crash; margin compression flagged (*Rask Media*; *Motley Fool Australia*; *stocksdownunder.com*; *simplywall.st*).
- **24 Feb 2026** — *"ARB Corp Ltd (ASX:ARB) (H1 2026) Earnings Call Highlights: Navigating Challenges with Strategic …"* (Yahoo Finance): US sales growth and retail expansion offset by currency impacts and OEM challenges.
- **20 Jan 2026** — Disappointing FY2026 trading update; share price reportedly fell ~11% (*Rask Media*; *ig.com*).

**Strategy and product:**
- **22 May 2026** — *"Did Deeper Toyota Land Cruiser FJ Integration Just Shift ARB's (ASX:ARB) Investment Narrative?"* (simplywall.st).
- **18 Jul 2026** — *"ARB (ASX:ARB) Launches New Ranger Cap With Valuation Back In Focus"* (simplywall.st).

**Governance and sentiment:**
- **17 Jun 2026** — Director Shona Faber on-market purchase of 5,420 shares at A$18.46 (*Kalkine*).
- **12 Feb 2026** — Insider buying totalling ~A$2.09m over twelve months (*Yahoo Finance*).

**Valuation and broker views:**
- **25 Feb 2026** — *"Brokers agree, ARB Corporation shares are looking seriously cheap"* (Motley Fool Australia).
- **8 May 2026** — *"Buy, hold, sell: ARB, Aurizon, and Goodman shares"* (Motley Fool Australia).
- **12 May / 14 Jul 2026** — Broker buy-list inclusions (Motley Fool Australia).

**Share-price narrative:**
- **15 Jul 2026** — *"ARB Corporation (ASX:ARB): Down Nearly Half in a Year — What's Happened to This 4WD Specialist?"* (Kalkine).
...
Risk: medium
Confidence: 0.65
Rationale: Deep research broadly supports the screen's buy signal on valuation, balance-sheet quality, and FCF generation, but tempered conviction is warranted by absent primary filings, unverified H1 FY2026 earnings deterioration, and ongoing margin/OEM headwinds that the screen may underweight.
