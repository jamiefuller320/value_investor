...
def test_supplement_company_metrics_cashflow_uses_cached_financials(tmp_path: Path):
...
def test_install_fetch_cashflow_fallback_patches_fetch(monkeypatch):
    ...
    # Reset any prior install from importing ingest_improvement in other tests.
